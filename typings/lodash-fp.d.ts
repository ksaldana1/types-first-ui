...
declare namespace fp {
  ...
  interface Static {
    ...
    getOr<TResult>(fallback: TResult, path: string): (object: any) => TResult;
    getOr<TObject, TResult>(
      fallback: TResult,
      path: string
    ): (object: TObject) => TResult;
    getOr<TResult>(fallback: TResult, path: string, object: any): TResult;
    getOr<TObject, TResult>(fallback: TResult, path: string, object: TObject): TResult;
     ...
     */
    set<T, U>(path: string, value: U, object: T): T;
    set<U>(path: string, value: U): <T>(object: T) => T;
    set(path: string): <T, U>(value: U, object: T) => T;
    set(path: string): <U>(value: U) => <T>(object: T) => T;

    unset<T, U>(path: string, object: T): T;
    unset(path: string): <T>(object: T) => T;
     ...
     */
    mapKeys<T1, T2 extends Dictionary<any>>(
      iteratee: (k: keyof T1) => keyof T2,
      object: T1
    ): T2;
    mapKeys<T1, T2 extends Dictionary<any>>(
      iteratee: (k: keyof T1) => keyof T2
